...
const Header = () => {
  ...
  return (
    <>
      <div className="navBar max-w-[1600px] m-auto bg-white sticky h-[70px] top-0 shadow-md flex justify-between items-center px-8 z-10 w-full smxl:pl-0 smxl:h-[60px] smxl:pr-3 sm:pr-4 sm:px-0 md:pl-0 md:pr-4 md1:pl-0 md1:pr-4 lg:pl-2 lg:pr-6">
