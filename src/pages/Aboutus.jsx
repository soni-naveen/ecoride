...
const Aboutus = () => {
  ...
  <div className="bg-white py-12 sm:py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md1:grid-cols-1 lg:grid-cols-2">
          <div className="order-2 md1:order-1">
            <h2 className="text-3xl font-extrabold text-dark-color sm:text-4xl lg:text-5xl">
              About Us
            </h2>
            <p className="mt-4 text-xl text-dark-color">
            ...
            <p className="mt-4 text-xl text-dark-color">
              At our core, we believe in honesty, integrity, and a strong moral
              compass. We strive to always do the right thing, no matter the
              challenge. Our team is driven by a commitment to excellence and a
              deep understanding of the industries we serve.
            </p>
            <p className="mt-4 text-xl text-dark-color">
          ...
          <div className="order-1  flex items-center justify-center">
            <img
              src={aboutuscar}
              alt="About Us"
              className="w-[80%] h-auto rounded-lg lg:h-64 "
            />
          </div>
        </div>

        <h2 className="text-3xl font-extrabold text-dark-color sm:text-4xl lg:text-5xl mt-12">
          Our Moral Values
        </h2>
        ...
        <div className="grid grid-cols-3 gap-8 smxl:grid-cols-1 lg:grid-cols-2 mt-12">
          <div className="bg-light-color shadow-md rounded-lg overflow-hidden p-6">
            <h3 className="text-xl font-bold text-dark-color mb-2">Integrity</h3>
          ...
          <div className="bg-light-color shadow-md rounded-lg overflow-hidden p-6">
            <h3 className="text-xl font-bold text-dark-color mb-2">Innovation</h3>
            <p className="text-dark-color">
          ...
          <div className="bg-light-color shadow-md rounded-lg overflow-hidden p-6">
            <h3 className="text-xl font-bold text-dark-color mb-2">Excellence</h3>
            <p className="text-dark-color">
          ...
          <div className="bg-light-color shadow-md rounded-lg overflow-hidden p-6">
            <h3 className="text-xl font-bold text-dark-color mb-2">Teamwork</h3>
            <p className="text-dark-color">
          ...
          <div className="bg-light-color shadow-md rounded-lg overflow-hidden p-6">
            <h3 className="text-xl font-bold text-dark-color mb-2">Empathy</h3>
            <p className="text-dark-color">
          ...
          <div className="bg-light-color shadow-md rounded-lg overflow-hidden p-6">
            <h3 className="text-xl font-bold text-dark-color mb-2">Resilience</h3>
            <p className="text-dark-color">
