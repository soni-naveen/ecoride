    ...
    <>
      ...
      >
        <div className="left mt-20 flex flex-col ">
          ...
          <div className="w-[35rem] h-[28rem] mb-10 relative flex flex-col items-center p-14 rounded-2xl bg-dark-color sm2xl:w-[17rem] smxl:w-[20rem] sm2xl:p-10 smxl:h-[27rem] smxl:p-10">
            <form
              action="/"
              id="form"
            ...
            >
              ...
              <div className="connectinglines flex flex-col items-center absolute top-[4.6rem] left-[7.1rem] sm2xl:top-[3.5rem] sm2xl:left-[2.2rem] smxl:left-[2.7rem] smxl:top-[3.5rem]">
